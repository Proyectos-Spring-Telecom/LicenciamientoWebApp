...
import { result, stubString } from 'lodash-es';
...
import { CountryInfo, ServiceGrafica } from '../../service/app.service';

@Component({
  selector: 'fury-dashboard-alumbrado',
  templateUrl: './dashboard-alumbrado.component.html',
  styleUrls: ['./dashboard-alumbrado.component.scss'],
  animations: [fadeInRightAnimation, fadeInUpAnimation],
  providers: [Service, ServiceGrafica]
})
export class DashboardAlumbradoComponent  implements OnInit {
